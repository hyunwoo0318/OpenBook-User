...
////             * ch4 -> Not Started
////             */
////            ChapterSection cp2 = new ChapterSection(customer1, ch2, ContentConst.TIME_FLOW_QUESTION);
////            ChapterSection cp3 = new ChapterSection(customer1, ch3, ContentConst.COMPLETE);
////            ChapterSection cp4 = new ChapterSection(customer1, ch4, ContentConst.NOT_STARTED);
////            chapterSectionRepository.saveAll(Arrays.asList(cp2, cp3, cp4));
//        }
//
//
...
////                    new ChapterUserDto(ch1.getTitle(), ch1.getNumber(), StateConst.OPEN, ContentConst.NOT_STARTED);
////                    new ChapterUserDto(ch1.getTitle(), ch1.getNumber(), StateConst.OPEN, ContentConst.NOT_STARTED);
////            assertThat(body.get(0)).usingRecursiveComparison().isEqualTo(chapter1Dto);
////
////            //2단원
////            ChapterUserDto chapter2Dto
////                    = new ChapterUserDto(ch2.getTitle(), ch2.getNumber(), StateConst.OPEN, ContentConst.TIME_FLOW_QUESTION);
////            assertThat(body.get(1)).usingRecursiveComparison().isEqualTo(chapter2Dto);
////
////            //3딘원
////            ChapterUserDto chapter3Dto
////                    = new ChapterUserDto(ch3.getTitle(), ch3.getNumber(), StateConst.OPEN, ContentConst.COMPLETE);
////            assertThat(body.get(2)).usingRecursiveComparison().isEqualTo(chapter3Dto);
////
////            //4단원
////            ChapterUserDto chapter4Dto
////                    = new ChapterUserDto(ch4.getTitle(), ch4.getNumber(), StateConst.OPEN, ContentConst.NOT_STARTED);
