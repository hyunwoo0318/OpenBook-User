...
public class RedisService {
    ...
    public void saveQuestionListToRedis(Integer roundNumber, List<ExamQuestionDto> questionDtoList) throws JsonProcessingException {
    ...
    public List<ExamQuestionDto> getQuestionListFromRedis(Integer roundNumber) throws JsonProcessingException {
