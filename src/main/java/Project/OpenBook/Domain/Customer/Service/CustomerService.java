...
public class CustomerService implements UserDetailsService {
    ...
    /** Oauth2 */
    @Transactional
    public TokenDto loginOauth2(
            String providerName, String code, String redirectUrl, String protocol)
            throws Exception {
        ...
        Optional<Customer> customerOptional =
                customerRepository.queryCustomer(oauthId, providerName);
                        ...
                        .map(
                                jl -> {
                                    return jl.getNumber() == 1
                                            ? new JJHListProgress(
                                                    customer, jl, StateConst.IN_PROGRESS)
                        ...
                        .map(
                                jc -> {
                                    return jc.getNumber() == 1
                                            ? new JJHContentProgress(
                                                    customer, jc, StateConst.IN_PROGRESS)
