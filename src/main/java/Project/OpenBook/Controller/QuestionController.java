...
public class QuestionController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "존재하지 않는 카테고리나 문제 타입 입력으로 인한 문제 수정 실패")
    })
    @PatchMapping("/admin/questions")
    public ResponseEntity updateQuestion(@Validated @RequestBody QuestionDto questionDto, BindingResult bindingResult) {
