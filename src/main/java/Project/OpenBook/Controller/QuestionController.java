...
//    }
    ...
    public ResponseEntity queryTimeFlowQuestion(@AuthenticationPrincipal Customer customer,
                                                @RequestParam("num") Integer num, @RequestParam("type")String type) {

        List<TimeFlowQuestionDto> timeFlowQuestionDtoList = questionService.queryTimeFlowQuestion(customer.getId(), num, type);
    ...
    public ResponseEntity queryGetTopicsByKeywordQuestion(@AuthenticationPrincipal Customer customer,
                                                          @RequestParam("num") Integer num){
        List<GetTopicByKeywordQuestionDto> questionList = questionService.queryGetTopicsByKeywordQuestion(customer.getId(), num);
    ...
    public ResponseEntity queryGetTopicsBySentenceQuestion(@AuthenticationPrincipal Customer customer,
                                                           @RequestParam("num") Integer num){

        List<GetTopicBySentenceQuestionDto> questionList = questionService.queryGetTopicsBySentenceQuestion(customer.getId(),num);
